...
public class StudentCSVWriter {
    ...
    public void writeAll(Student[] students) {
        try (FileWriter writer = new FileWriter(fileName)) {
            ...
            System.err.println("Could not write to the students file");
            e.printStackTrace();
        }
    }
    ...
    public void write(Student student) {
        try (FileWriter writer = new FileWriter(fileName, true)) {
            ...
            System.err.println("Could not write to students file");
            e.printStackTrace();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        StudentCSVWriter writer = new StudentCSVWriter("data/students.csv", " ");
